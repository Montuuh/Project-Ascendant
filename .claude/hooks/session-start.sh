...
if [ -f "$SESSION_STATE" ]; then
  ...
  echo "No active session state found. Run /sprint-plan to set one up."
  echo "Or check the Notion BACKLOG for current topic and open decisions."
  echo ""
fi
...
echo "--- GDD Workflow Reminder ---"
echo "Canonical docs live in Notion. Use the project-ascendant-gdd skill"
echo "to read/write GDD pages before implementing any system."
echo ""
echo "Design Pillars:"
